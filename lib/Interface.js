export default class Interface {
    ...
    static editBondDlg(that) {
        if (that.bondslist.length > 0) {
            ...
            this.modal(text, that.parent, that.addBonds.bind(that), items, "table", fixedBonds)//, that.chainname);//that.bondslist);
            that.chaindict = chaindict;
            that.chainname = chainname;
        }
    }
    ...
    static modal(title, parent, submitFunction, items, options, fieldData, chaindict) {
        var toAttach = []
