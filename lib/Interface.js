export default class Interface {
    ...
    static addRow(table, row, fields, sortedRow) {
        const addedRows = [];
        ...
        for (const [key, value] of row) {
            ...
            if (c == 0) {      // the first column.
                ...
                td.appendChild(chk);
                //alternate method where button is added instead
            ...
            if (rowType.type == "color") {
                ...
                //ele.setAttribute('value', value)//rowType.items[value]);
                //var option = document.createElement("option");
                //option.value = rowType.items;
        ...
        if (!items) {
           ...
           // table.setAttribute("border", 1);
            ...
            for (const [key, value] of Object.entries(fieldData)) {
                ...
                //this.addRow(table, value, fields);
            }
            ...
            submitButton.addEventListener("click", () => {
                ...
                for (var i in toAttach) {
                    ...
                    if (element.tagName === "TBODY") {
                        ...
                        //for (var [rowNumber, row] in Object.entries(element.childNodes)) {
                        //forEach((element, index) => { ... } )

                        //for (var rowNumber in children) {
                            ...
                            if (row && row.className === "table") {
                                ...
                                rowChildren.forEach((col, colNumber) => {
                                    ...
                                    if (col.children[0].type == "checkbox")
                                        dataRow[column] = col.children[0].checked;// == "on" ? true : false;
                                        //data[rowNumber][column] = col.children[0].value == "on" ? true : false;
                                    else
                                        dataRow[column] = col.children[0].value;
                                        //data[rowNumber][column] = col.children[0].value;
                                });
                                data.push(dataRow);
