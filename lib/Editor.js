...
export default class Editor {
    ...
    buildToolbar(parentid, rootUrl) {
        ...
        let buttons = [
            { iconurl: rootUrl + "images/icons8-create-64.png", tooltips: "Clear Editor Chains", onclick: function () { me.newBlankEditor(parent); } },
            { iconurl: rootUrl + "images/icons8-biotech-50.png", tooltips: "Import Fasta Sequence or Chain", onclick: function () { me.createDlg(parent); } },
            { iconurl: rootUrl + "images/bio-add.png", tooltips: "Add Blank Chain", onclick: function () { me.newBlankChain(parent); } },
            { iconurl: rootUrl + "images/icons8-event-log-50.png", tooltips: "Remove Highlighted Chain", onclick: function () { me.deleteChainDlg(); } },
            { iconurl: rootUrl + "images/molecule.png", tooltips: "Add a Bond", onclick: function () { Interface.addBondDlg(me); } },
            { iconurl: rootUrl + "images/chemical.png", tooltips: "Edit/Delete Bonds", onclick: function () { Interface.editBondDlg(me); } },
            { iconurl: rootUrl + "images/icons8-add-property-50.png", tooltips: "Add an Annotation", onclick: function () { Interface.addAnnotationDlg(me); } },
            { iconurl: rootUrl + "images/icons8-outline-50.png", tooltips: "Edit/Delete Annotations", onclick: function () { Interface.editAnnotationDlg(me); } },
            { iconurl: rootUrl + "images/icons8-refresh-52.png", tooltips: "Rerender Bonds and Annotations", onclick: function () { me.rebuildEditors(); } },
            { iconurl: rootUrl + "images/icons8-code-50.png", tooltips: "Get XML", onclick: function () { me.getXml(); } },            
            { iconurl: rootUrl + "images/icons8-code-502.png", tooltips: "Set XML", onclick: function () { me.createDlg(parent, "xml"); } }
