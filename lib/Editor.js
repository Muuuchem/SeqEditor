...
';
        ...
        if (this.currentSelected) {
            ...
            for (var i = 0; i < this.editorIndices.length; i++) {
                if (this.editorIndices[i] == this.currentId)
                    ...
                    //removeArrayIndex(this.editorIndices, this.currentId);
            }
    ...
    buildToolbar(parentid) {
        ...
        var buttons = [
            ...
            { iconurl: "http://localhost:8080/images/molecule.png", tooltips: "Add a Bond", onclick: function () { me.addBondDlg(); } },
            { iconurl: "http://localhost:8080/images/chemical.png", tooltips: "Add/Edit Bonds", onclick: function () { me.editBondDlg(parent); } },
            { iconurl: "http://localhost:8080/images/icons8-add-property-50.png", tooltips: "Add Annotation", onclick: function () { me.addAnnotationDlg(); } },
...
//},
    ...
    //    var me = this;
    //    this.addbondtypedlg = Interface.modal("Add Bond Type", items, { src: scil.App.imgSmall("submit.png"), label: "Create", onclick: function () { me.addBondTypes(); } });
