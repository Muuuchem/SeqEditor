export default class SequenceEditor {
    ...
    constructor(parent, sequence, title, num, that, rowNumber) {
        ...
        this.addEditorHtml(parent, rowNumber, title);
    ...
    addEditorHtml(parent, rowNumber, title) {
        let rowNums = "&nbsp;";
        for (let i = 1; i <= rowNumber; i++) {
            rowNums += i + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        }
        parent.innerHTML += '\
        <table id="editTable' + this.num + '" style="position:absolute;table-layout:fixed;"> \
            <tbody> \
                <tr> \
                    <td style="width:50px;display:inline-block;"></td> \
                    <td id="title' + this.num + '" style="display:inline-block;">' + title + '</td> \
                </tr> \
                <tr> \
                    <td style="width:50px;display:inline-block;"></td> \
                ...
                <tr> \
                    <td id="vert' + this.num + '" width="50" style="display:inline-block;width:50px;text-align:right;padding-right:10px;vertical-align:top;font-size:20px;font-family:monospace;color:rgb(221, 221, 221);"></td> \
                    <td style="display:inline-block;position:absolute;"> \
                        <div class="editor" style="position:absolute;pointer-events:none;" id="editor' + this.num + '"></div> \
                        <div contenteditable="false" id="paragraph' + this.num + '" spellcheck="false" style="font-family:monospace;font-size:20px;display:inline-block;word-break:break-word;"></div> \
                    </td> \
                </tr> \
            </tbody> \
        </table> \
    ...
    countStackedBonds(sequence, count) {//counts the number of unique bonds on the row
    ...
    buildFullEditor(sequence, colors, annotationNotes, inner) {//need to pass in inner and specific outer from editor similarly to annoationnotes
        ...
        for (let i = 0; i < stringSplit.length; i++) {
            ...
            if (count % this.rowLength == 0 && paragraph.innerHTML[paragraph.innerHTML.length - 2] != 'r' && !buildingSpan && !finishedRows[count]) {
                let heightincrease = this.countStackedBonds(sequence, i) + 1;
                let newline = "";
                var addNum = Math.ceil(heightincrease / 7);
                if (count != 0) {
                    newline += "<br/>"
                    vertNums += "<br/>"
                }
